/**
 * seed-new-ingredients-batch.mjs
 * Uploads the new ingredient markdown files to Supabase.
 * Parses frontmatter and markdown sections from full_recipes/ingredients/.
...
function parseOverview(body) {
  // Overview is the paragraph after the # heading and *subtitle* line, before the first ---
...
async function main() {
  console.log('================================================')
  console.log(' Ancient Pantry — New Ingredients Batch Upload')
  console.log('================================================\n')
  ...
  for (const slug of SLUGS) {
    ...
    const overview = sections['Overview'] || parseOverview(body) || null
    ...
    const traditionalDishesRaw = sections['Traditional Dishes'] || ''
    const traditional_dishes = parseTraditionalDishes(traditionalDishesRaw)
