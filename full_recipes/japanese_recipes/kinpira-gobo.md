...
cuisine: Japanese
course: Side
tags: [japanese, vegetable, side-dish, burdock, root-vegetable, sesame, vegan, plant-based, bento, make-ahead, quick]
ingredients_key: [burdock root, carrot, toasted sesame oil, soy sauce, mirin, sake, sugar, dried red chili, sesame seeds]
equipment_key: [large skillet, cutting board, knife, bowl]
hero_image_prompt: A small ceramic bowl filled with julienned burdock root and carrot braised in a glossy soy glaze, sprinkled with white sesame seeds, a single dried red chili resting on top, set on a dark wooden surface with soft natural light from the left
seo_title: Kinpira Gobo Japanese Braised Burdock Root with Carrot and Sesame
meta_description: Classic kinpira gobo recipe with julienned burdock root and carrot braised in sweet soy sauce, mirin, and sake, finished with toasted sesame oil and seeds. A staple Japanese side dish ready in 30 minutes.
medical_notes: Burdock root (gobo) is rich in inulin, a prebiotic fiber that supports gut health and feeds beneficial intestinal bacteria. It also contains chlorogenic acid and other polyphenols studied for antioxidant properties. Sesame seeds provide calcium, magnesium, iron, and lignans such as sesamin and sesamolin. Carrots contribute beta-carotene, a precursor to vitamin A. These notes reflect general nutritional content, not medical claims.
---
...
Kinpira gobo is one of those dishes that defines Japanese home cooking at its most honest. There is no spectacle here, no layered technique or dramatic plating. It is simply burdock root and carrot, cut into thin matchsticks, stir-fried in sesame oil, and simmered until the liquid reduces to a glossy, sweet-savory glaze. It appears in bento boxes, on dinner tables alongside [miso-shiru](/recipes/miso-shiru) and rice, and in the small dish section of teishoku set meals at neighborhood restaurants across Japan. It is the kind of side dish that quietly holds a meal together.
...
Burdock root has deep roots in East Asian food cultures. In Japan it has been cultivated for centuries and is valued both as a culinary ingredient and for its fiber content. It pairs naturally with other soy-dressed dishes like [hijiki-salad](/recipes/hijiki-salad) and sits comfortably alongside heartier plates such as [nikujaga](/recipes/nikujaga) or [takikomi-gohan](/recipes/takikomi-gohan). The dish keeps well for several days, and many home cooks prepare a large batch early in the week to portion out as needed. It is the sort of recipe you return to without thinking, the way you reach for a familiar book on the shelf.
...
### For the vegetables
- 270 g gobo (burdock root), about 1 medium root
- 70 g carrot, about one-third of a medium carrot
- 22 ml toasted sesame oil (1 1/2 tablespoons)

### For the seasoning
- 12 g sugar (1 tablespoon)
- 15 ml sake (1 tablespoon)
- 15 ml mirin (1 tablespoon)
- 22 ml soy sauce (1 1/2 tablespoons)
- 1 dried red chili pepper, seeds removed (optional)

### For the garnish
- 6 g toasted white sesame seeds (2 teaspoons)
...
2. Soak the burdock in the water for about 10 minutes, changing the water once halfway through when it turns murky brown. This removes some of the astringency while keeping the characteristic gobo flavor. Drain well and pat dry.

3. Peel the carrot and cut it into matchsticks the same size as the burdock. Remove the seeds from the dried red chili if using, and slice it into thin rings or leave it whole.

4. Heat the toasted sesame oil in a large skillet over medium heat until it shimmers slightly. Add the burdock and stir-fry for 2 to 3 minutes, moving the pieces frequently so they cook evenly. The matchsticks will begin to soften at the edges and turn slightly translucent.

5. Add the carrot and continue stir-frying for another minute until both vegetables are nearly tender but still have a gentle bite when you press a piece between your fingers.

6. Add the sugar, sake, mirin, and soy sauce. Stir to coat the vegetables evenly. Tuck in the dried chili if using. Reduce the heat to medium-low and cook, stirring occasionally, until the liquid has nearly evaporated and the vegetables are coated in a thin, glossy glaze. This takes about 3 to 4 minutes. Listen for the sizzle to become quieter as the liquid reduces.

7. Remove the pan from the heat. Sprinkle the sesame seeds over the top and toss gently to distribute them. Taste and adjust with a small splash of soy sauce if needed.

8. Transfer to a serving dish. Kinpira gobo is delicious warm, at room temperature, or cold from the refrigerator.
...
Kinpira gobo belongs in the supporting role at a Japanese meal. Serve it alongside steamed rice and [miso-shiru](/recipes/miso-shiru) for a simple weeknight dinner. It pairs well with grilled fish, [soba](/recipes/soba) noodles, or a warm bowl of [takikomi-gohan](/recipes/takikomi-gohan). For a vegetable-forward spread, set it out with [hijiki-salad](/recipes/hijiki-salad) and a plate of cold tofu dressed with ginger and soy.
...
For a cross-cultural table, kinpira sits comfortably next to [japchae](/recipes/japchae), which uses a similar sweet-soy seasoning profile on glass noodles and vegetables. The earthy chew of the burdock contrasts nicely with the slippery softness of the noodles.
