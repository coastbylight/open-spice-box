...
tags: [indian, Tamil Nadu, South India, sambar, toor dal, tamarind, vegetarian, vegan, lentils, stew, breakfast, lunch]
ingredients_key: [toor dal, tamarind, sambar powder, mixed vegetables, mustard seeds, curry leaves, asafoetida]
equipment_key: [pressure cooker or pot, heavy-based saucepan]
hero_image_prompt: A wide clay bowl of deep amber sambar with visible pieces of drumstick and brinjal, a dark tempering of mustard seeds and curry leaves pooled on the surface, bright green coriander scattered across, steam rising, lit warmly against a dark wooden surface
seo_title: Sambar Recipe — Authentic Tamil Nadu Tamarind and Lentil Vegetable Stew
meta_description: Classic Tamil Nadu sambar made with toor dal, tamarind, mixed vegetables, and sambar powder, finished with a sputtering mustard and curry leaf tempering. Serve with idli, dosa or rice.
medical_notes: Tamarind is traditionally used in South Indian cooking as a digestive and for its sharp organic acid content. Toor dal is high in protein and dietary fibre. Asafoetida is traditionally used as a carminative.
---
...
**For the sambar**
- 200 g toor dal (split pigeon peas), rinsed
- 200 g mixed vegetables: drumstick (moringa pods), brinjal (eggplant), shallots, tomato, and pumpkin — cut into medium pieces
- 20 g tamarind block (about a walnut-sized piece), soaked in 200 ml warm water for 15 minutes
- 20 g sambar powder (about 4 teaspoons)
- 5 g turmeric (about 1 teaspoon)
- 5 g fine salt (about 1 teaspoon), or to taste

**For the tempering (tadka)**
- 20 ml neutral oil
- 5 g black mustard seeds (about 1 teaspoon)
- 5 g fresh curry leaves (about 12–15 leaves, one sprig)
- 3 g dried red chillies (about 3 whole chillies)
- 3 g asafoetida / hing (about ½ teaspoon)
