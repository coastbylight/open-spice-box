...
meta_description: Learn to make authentic Masale Bhaat — the beloved Maharashtrian festive rice dish seasoned with goda masala, cashews, and fresh coconut. A complete one-pot recipe with method, notes, and variations.
medical_notes: Goda masala contains stone flower (dagad phool), which is traditionally used for digestive support in Ayurvedic practice. Research suggests some spices in the blend, including sesame and coconut, provide beneficial fatty acids and antioxidants. Asafoetida (hing), if present in your goda masala, is traditionally used to reduce flatulence and ease digestion.
---
...
|---|---|
| Yield | 4 servings |
| Prep | 30 minutes (including 20-minute rice soak) |
| Cook | 30 minutes |
| Total | 1 hour |
| Difficulty | Intermediate |
...
- 300g basmati rice, soaked in cold water for 20 minutes, drained
- 200g mixed vegetables: brinjal (eggplant) cut into 2cm cubes, potato cut into 2cm cubes, green peas (fresh or frozen), drumstick cut into 5cm lengths
- 30g ghee, plus extra for finishing
- 1 tsp mustard seeds
...
- 25g raw peanuts
- ½ tsp turmeric powder
- 20g goda masala (see notes)
- 450ml water (1.5x the volume of drained rice)
...
**1. Prepare the rice.**
Wash the basmati rice (300 g) in several changes of cold water (450 ml) until it runs mostly clear. Soak in fresh cold water for 20 minutes. Drain well in a fine sieve and set aside.

**2. Build the tadka.**
In a heavy-bottomed pot or Dutch oven, heat the ghee (30 g) over medium heat. Add the mustard seeds (1 tsp) and let them sputter and pop, about 30 seconds. Add the curry leaves (they will crackle), the dried red chilli (1), cloves (2), and cinnamon stick (1). Stir for 20 seconds until fragrant.

**3. Fry the nuts.**
Add the cashews (25 g) and peanuts (25 g) to the pot. Fry, stirring constantly, for 2–3 minutes until lightly golden. They will continue to colour as the dish cooks, so stop while they are pale gold.

**4. Sauté the vegetables.**
Add the brinjal, potato, and drumstick pieces. Sprinkle over the turmeric (½ tsp). Sauté for 4–5 minutes, stirring occasionally, until the vegetables are lightly coated in spiced ghee (1 tbsp) and just beginning to soften at the edges. Add the peas and stir through.

**5. Add the rice and goda masala.**
Add the drained rice to the pot. Add the goda masala (20 g). Stir gently but thoroughly for 2 minutes, toasting the spiced rice in the ghee. Every grain should be coated and the masala fragrance should open fully.

**6. Add water and cook.**
Pour in 450ml water and add the salt (1 tsp). Stir once to combine. Bring to a boil over medium-high heat, then reduce the heat to the lowest setting. Cover the pot with a tight-fitting lid. Cook undisturbed for 15–18 minutes, until all water is absorbed and the rice is tender and separate.

**7. Rest and fluff.**
Remove from heat. Let the pot sit, covered, for 5 minutes. Then drizzle over the remaining tablespoon of ghee and gently fluff the rice with a fork, separating any clumped grains. Take care not to break the vegetables.

**8. Garnish and serve.**
Transfer to a serving dish or serve directly from the pot. Top with grated fresh coconut (40 g) and chopped coriander (3 tbsp). Add a squeeze of lime if you like. Serve immediately.
