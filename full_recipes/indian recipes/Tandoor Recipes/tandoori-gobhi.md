...
- 2.8 kg cauliflower, cut into medium florets (about 5–6 cm each)
- 70 g ginger garlic paste
...
Cut the cauliflower (5–6 cm each) into medium florets of roughly equal size — this ensures even cooking. Wash the florets and drain thoroughly. Pat dry if needed. Place on a tray in a single layer.

**2. Pre-season.**
Sprinkle the florets with salt (10 g) and yellow chilli (30 g) powder (20 g). Toss to coat lightly. This initial seasoning begins to penetrate the cauliflower and draws out a little moisture.

**3. Make the batter.**
In a large bowl, combine the gram flour (500 g), ginger garlic paste (70 g), chaat masala (20 g), additional salt (adjust for the seasoning already applied), red chilli powder, ajwain (15 g), garam masala (5 g), turmeric (5 g), and lemon juice (60 ml). Mix well. Add water gradually — a little at a time — to form a thick batter that coats the back of a spoon heavily. The batter should be thick enough that when a floret is dipped, it holds a significant coating that does not immediately run off.

**4. Coat the florets.**
Add the cauliflower florets to the batter and toss to coat each floret thoroughly. Every surface should be covered. Let the coated florets rest for 30 minutes at room temperature — this allows the batter to adhere and the ajwain to begin releasing its oils into the coating.

**5. Shallow fry.**
Heat oil in a wide, heavy pan to about 170°C — enough oil to come halfway up the florets. Working in batches, shallow fry the battered florets for 3–4 minutes per side until the batter is set and light golden. Do not crowd the pan. Remove with a slotted spoon and drain on a rack. The florets should be partly cooked, with the batter set but not deeply coloured.

**6. Skewer and tandoor.**
Thread the shallow-fried florets onto metal skewers — 5–6 per skewer, depending on size. Cook in a hot tandoor for 4–5 minutes, rotating the skewer once, until the batter is deeply blistered and charred in patches and the cauliflower is cooked through and tender.

If cooking without a tandoor: place the fried florets on a wire rack over a baking tray. Cook in a preheated oven at 230°C for 8–10 minutes, then briefly under the highest broiler setting for 2–3 minutes to develop char. Alternatively, finish directly over an open gas flame on a wire rack for an authentic smoky finish.

**7. Finish and serve.**
Remove from skewers. Sprinkle with kebab masala (5 g). Serve immediately with lemon wedges.
