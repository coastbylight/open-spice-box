...
cuisine: Korean
course: Soup
tags: [ginseng, chicken soup, Korean soup, samgyetang, summer soup, stuffed chicken, traditional, comfort food, restorative]
ingredients_key: [Cornish hen, sweet rice, ginseng, jujubes, garlic, ginger, scallions]
equipment_key: [large stockpot, kitchen twine, toothpicks]
hero_image_prompt: A whole small chicken in a deep stone bowl filled with pale golden broth, ginseng root and jujubes visible alongside, steam rising, on a dark wooden table with small dishes of salt and scallions nearby
seo_title: Samgyetang — Korean Ginseng Chicken Soup with Sweet Rice and Jujubes
meta_description: Samgyetang is a classic Korean ginseng chicken soup made with a whole young chicken stuffed with sweet rice, garlic, and jujubes. Simple, deeply nourishing, and traditional.
medical_notes: Ginseng is used in traditional Korean and Chinese medicine. Any health-related claims in this recipe reflect traditional use, not medical advice. Consult a healthcare provider before using ginseng if you are pregnant, nursing, or taking medications.
---
...
Unlike [seolleongtang](/recipes/seolleongtang) or [galbitang](/recipes/galbitang), which build flavor from bones over many hours, samgyetang gets its character from the stuffing and the ginseng. The broth is mild by design. Each person seasons their own bowl with salt and pepper at the table, which is part of the ritual. A small dish of coarse salt, some chopped scallions, and perhaps a side of [kkakdugi](/recipes/kkakdugi) are all you need alongside.
...
**Chicken**
- 2 Cornish game hens (about 680 g each), or 1 small whole chicken (about 1.4 kg)

**Stuffing**
- 45 g sweet rice (glutinous rice), soaked in water for at least 1 hour
- 6 garlic cloves, peeled
- 1 fresh ginseng root (about 15 g), or 2 small dried ginseng roots, rehydrated

**Aromatics**
- 4 dried jujubes (daechu)
- 2 thin slices fresh ginger (about 2.5 cm each)
- 1 scallion, white part only

**Broth**
- 1.5 L water or light chicken stock
...
1. Prepare the chickens. Rinse each hen inside and out under cold water. Pat dry with paper towels. Use a paper towel to wipe away any remaining blood inside the cavity. Trim excess fat from the openings but leave the skin intact.

2. Stuff the cavity. Drain the soaked sweet rice. Divide it between the two hens, spooning it into each cavity along with 3 garlic cloves and half the ginseng root. Leave about a quarter of the cavity empty so the rice has room to expand as it cooks. If the ginseng root has small offshoots, tuck those in as well.

3. Close the chickens. Cross the legs of each hen and tie them with kitchen twine, or make a small cut in the skin between one thigh and the cavity, then thread the opposite leg through to hold everything shut. Secure the neck cavity with a toothpick if needed. The goal is to keep the rice inside during cooking.

4. Build the pot. Place the stuffed hens breast-side up in a pot just large enough to hold them snugly. Add the jujubes, ginger slices, and scallion white. Pour in 6 cups of water or stock. The liquid should come about three-quarters of the way up the chickens.
...
6. Rest and serve. Turn off the heat and let the pot sit covered for 10 minutes. Transfer each hen carefully to a deep individual bowl. Ladle the hot broth over and around the chicken. Serve immediately with chopped scallions, coarse salt, and black pepper on the side for each person to season their own bowl.
...
Samgyetang is traditionally a one-bowl meal. Each person gets their own hen in a stone pot or deep bowl. Set out small dishes of coarse salt and black pepper for individual seasoning. A plate of [kkakdugi](/recipes/kkakdugi) provides crunch and acidity. [Baek-kimchi](/recipes/baek-kimchi) is another excellent pairing, offering contrast without heat.
...
For a fuller table, serve with [oi-muchim](/recipes/oi-muchim) and a simple bowl of steamed rice on the side, though the rice inside the chicken is usually enough starch for most appetites.
