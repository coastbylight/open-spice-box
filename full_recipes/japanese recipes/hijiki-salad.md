...
cuisine: Japanese
course: Side
tags: [japanese, seaweed, hijiki, nimono, side-dish, vegan-adaptable, meal-prep, washoku, plant-based, simmered, make-ahead]
ingredients_key: [dried hijiki, aburaage, konnyaku, carrot, lotus root, edamame, dashi, soy sauce, mirin, sugar, neutral oil]
equipment_key: [medium pot with lid, fine-mesh strainer, cutting board]
hero_image_prompt: A small white ceramic bowl filled with dark hijiki seaweed salad showing slender black strands mixed with orange carrot matchsticks, pale triangles of fried tofu, and bright green edamame beans, glistening with a sweet soy glaze, set on a wooden surface with chopsticks resting alongside, overhead shot with soft natural light
seo_title: Hijiki Seaweed Salad (Hijiki no Nimono) - Classic Japanese Simmered Side Dish
meta_description: Traditional Japanese hijiki seaweed salad simmered with carrot, fried tofu, and edamame in a dashi-sweetened soy broth. A nutrient-rich side dish that keeps well for days.
medical_notes: Hijiki is rich in dietary fiber, calcium, iron, and magnesium. However, hijiki contains inorganic arsenic at higher levels than other edible seaweeds. Some food safety agencies (notably the UK FSA and Health Canada) have advised limiting consumption. Japanese health authorities consider moderate intake safe within a varied diet. Soaking and draining hijiki before cooking reduces arsenic content. Pregnant individuals and young children may wish to consult a healthcare provider before consuming hijiki regularly. These notes reflect general nutritional information, not medical claims.
---
...
In Japanese home cooking, hijiki no nimono is a staple of [bento boxes](/recipes/takikomi-gohan) and weekly meal prep. It keeps beautifully in the refrigerator for several days and freezes well, making it a practical addition to any rotation of side dishes. You will find similar approaches to braised vegetables in [kinpira gobo](/recipes/kinpira-gobo), which uses the same soy-mirin base for burdock root. If you enjoy the mineral quality of sea vegetables, [miyeok-guk](/recipes/miyeok-guk) offers another perspective through the Korean tradition of seaweed soup, while [miso shiru](/recipes/miso-shiru) provides a lighter way to bring ocean flavors to a daily meal.
...
### For the simmer
- 2 sheets aburaage (deep-fried tofu pouches), about 60 g total
- 85 g carrot (roughly 1 medium), cut into thin matchsticks
- 85 g konnyaku (konjac), cut into thin strips (optional)
- 35 g lotus root (renkon), peeled and cut into thin quarter-rounds (optional)
- 1 tablespoon neutral oil (such as rapeseed or rice bran)
- 480 ml dashi
- 60 ml mirin
- 30 g sugar
- 60 ml soy sauce
...
### To finish
- 50 g shelled edamame, cooked (optional)

---

## Method

1. Place the dried hijiki in a bowl and cover with the soaking water. Let it sit for 20 to 30 minutes. The strands will swell to several times their dry volume and turn from stiff to pliable. Drain through a fine-mesh strainer and rinse under cold running water. Squeeze gently and set aside.

2. Bring a small pot of water to a boil. Pour the boiling water over the aburaage in a bowl to remove excess surface oil, or briefly blanch them for 30 seconds. This step keeps the finished dish from tasting greasy. Pat dry, cut each sheet in half lengthwise, then slice crosswise into thin 5 mm strips.

3. If using konnyaku, tear or cut it into thin strips about 5 cm long. Boil for 3 minutes to remove its alkaline odor, then drain. The surface should feel less slippery after blanching.

4. Cut the carrot into matchsticks roughly the same length as the konnyaku strips. If using lotus root, cut into thin quarter-rounds about 3 mm thick.

5. Heat the oil in a medium pot over medium heat. Add the carrot and lotus root and stir for about 1 minute until the oil coats the pieces evenly and the carrot begins to soften slightly at the edges.

6. Add the drained hijiki, konnyaku, and aburaage strips. Stir everything together for another minute so the flavors begin to mingle.

7. Pour in the dashi and raise the heat to bring the mixture to a gentle boil. Skim any foam that rises to the surface.

8. Add the mirin, sugar, and soy sauce. Stir once to dissolve the sugar, then reduce the heat to medium-low. Cover with a lid and simmer for 20 to 25 minutes. The hijiki should be tender and the broth noticeably reduced.

9. Remove the lid and raise the heat slightly. Cook uncovered for another 5 to 8 minutes, stirring occasionally, until most of the liquid has evaporated and a thin glaze coats the ingredients. You should see the bottom of the pot between stirs.

10. If using edamame, fold them in gently during the last minute of cooking. They need only enough time to warm through and absorb a little of the glaze.

11. Remove from heat and let the salad cool to room temperature before serving. The flavors deepen as it sits.
...
Hijiki no nimono is a side dish by nature. Serve a small mound alongside rice and [miso shiru](/recipes/miso-shiru) for a simple washoku meal. It pairs naturally with grilled fish and pickled vegetables in a traditional ichiju sansai (one soup, three sides) arrangement.
...
For a more substantial spread, set it alongside [kinpira gobo](/recipes/kinpira-gobo) and a bowl of [takikomi gohan](/recipes/takikomi-gohan) for a fully plant-centered Japanese meal. The earthy burdock root and the seasoned mixed rice complement the sea-mineral quality of the hijiki.

If you enjoy building meals around sea vegetables and fermented flavors, consider pairing it with [gado-gado](/recipes/gado-gado) or [som tam](/recipes/som-tam) for an informal cross-cultural side dish spread where each plate brings a different kind of acidity, sweetness, and texture.
