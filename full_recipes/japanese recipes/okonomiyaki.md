...
cuisine: Japanese
course: Main
tags: [japanese, okonomiyaki, pancake, cabbage, street-food, osaka, kansai, griddle, pork-belly, weeknight, comfort-food, customizable]
ingredients_key: [cabbage, eggs, flour, dashi, nagaimo, pork belly, okonomiyaki sauce, kewpie mayonnaise, bonito flakes, aonori]
equipment_key: [large non-stick skillet or griddle, wide spatula, mixing bowl, grater]
hero_image_prompt: A close-up overhead shot of a golden-brown okonomiyaki on a dark iron griddle, drizzled in glossy brown sauce and white mayo in crosshatch lines, topped with a mound of pale pink bonito flakes curling in the rising heat, scattered green aonori seaweed, warm golden light from the side
seo_title: Okonomiyaki (Osaka-Style Japanese Savory Pancake) Recipe
meta_description: A thick Osaka-style savory pancake loaded with cabbage, pork belly, and dashi batter, topped with sweet sauce, mayo, and bonito flakes. Authentic homemade recipe.
medical_notes: Cabbage is a source of vitamin C, vitamin K, and dietary fiber. Nagaimo (Japanese mountain yam) contains mucilage polysaccharides traditionally associated with digestive support in Japanese folk medicine. Bonito flakes provide inosinate, a natural source of umami. Eggs supply complete protein and choline. These notes reflect general nutritional information, not medical claims.
---
...
- 200 ml dashi stock, cooled (or 200 ml water with 5 g dashi powder)
- 4 large eggs
- 100 g nagaimo (Japanese mountain yam), peeled and finely grated, optional but recommended
- 5 ml soy sauce (about 1 teaspoon)
- Pinch of fine sea salt

### Filling

- 400 g green cabbage, finely shredded (about a quarter of a medium head)
- 4 scallions, thinly sliced
- 40 g tenkasu (tempura scraps), or substitute crushed plain rice crackers
- 20 g pickled red ginger (benishoga), roughly chopped

### Topping protein

- 200 g thinly sliced pork belly (about 8 to 12 slices)

### For cooking

- 30 ml neutral oil such as vegetable or rice bran (about 2 tablespoons)
...
1. Whisk together the flour, cooled dashi, and soy sauce in a large bowl until smooth. Avoid overworking the batter. If small lumps remain, that is fine. Let it rest for 15 minutes while you prepare the remaining ingredients. Resting allows the gluten to relax and the flour to hydrate evenly.

2. While the batter rests, shred the cabbage into thin strips no wider than 5 mm. The finer the shred, the more evenly it cooks and the better it binds with the batter. Slice the scallions and chop the pickled ginger.

3. After resting, add the grated nagaimo and one egg to the batter. Stir until the nagaimo is fully incorporated. The batter will become noticeably lighter and slightly slippery in texture.

4. Divide the shredded cabbage into four equal portions. Add one portion of cabbage, a quarter of the scallions, a quarter of the tenkasu, and a quarter of the pickled ginger to the batter. Crack one egg into the bowl. Fold everything together gently with a spatula, lifting from the bottom rather than stirring in circles. The cabbage should be coated but not compressed. Overmixing deflates the batter and produces a dense pancake.
...
6. Lay 2 to 3 slices of pork belly across the top of the uncooked surface, arranging them so they cover most of the pancake. The pork will cook when you flip.

7. Cook undisturbed for 5 to 6 minutes over medium heat. Resist the urge to lift and check constantly. You will know the bottom is ready when the edges look set and dry, the pancake holds together when you slide a spatula underneath, and the underside is an even golden brown.
...
9. Flip once more so the pork side faces up. Lower the heat slightly and cook for another 2 minutes to ensure the interior is set. The center should feel firm but springy when pressed gently with a spatula, not liquid or wobbly.

10. Transfer the finished okonomiyaki to a plate. Immediately drizzle okonomiyaki sauce generously across the surface in broad zigzag lines. Follow with Kewpie mayonnaise in thinner crosshatch lines.

11. Pile a generous handful of bonito flakes on top while the pancake is still hot. Watch them curl and dance in the steam. Finish with a dusting of aonori powder.

12. Repeat steps 4 through 11 with the remaining three portions of cabbage and batter, adding one egg to each batch. Wipe the skillet clean between pancakes if residue builds up, and add fresh oil for each round.

13. Serve immediately. Okonomiyaki is best eaten hot, cut into wedges at the table. In Osaka, it is traditional to eat it with chopsticks directly from the griddle, but a fork works just as well.
...
Okonomiyaki is a complete meal on its own, but in izakaya-style dining it often appears alongside cold beer, edamame, and small plates. Serve with a bowl of [miso shiru](/recipes/miso-shiru) for a lighter accompaniment. In Japan, okonomiyaki is never served over rice, as it already contains flour and is considered a starch-based dish, though this convention is not universal outside Osaka. A simple green salad dressed with rice vinegar and sesame oil cuts through the richness nicely.
