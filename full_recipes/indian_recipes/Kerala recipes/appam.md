...
total_time: 15 hours (mostly hands-off)
difficulty: Medium
cuisine: Kerala
course: Breakfast / Main
tags: [Kerala, appam, fermented, rice, coconut milk, breakfast, vegan, gluten-free, South Indian]
ingredients_key: [raw rice, coconut milk, yeast]
equipment_key: [appam pan (chatty) or small wok, ladle]
hero_image_prompt: A single appam in a round iron chatty pan — lacy golden-brown edges curling slightly inward, the center pale and pillowy white, glistening with steam, a small bowl of sweetened coconut milk alongside, photographed close and directly from above on a dark slate surface
seo_title: Appam Recipe — Kerala Fermented Rice Crepe with Lacy Edges
meta_description: Appam is the iconic Kerala breakfast — a fermented rice batter poured into a curved pan and swirled to create lacy crisp edges around a soft, cloud-like center.
medical_notes: Contains coconut. Fermented foods may not be suitable for those with yeast sensitivities.
---
...
| | |
|---|---|
| Yield | Makes 16–18 appam (serves 4) |
| Prep | 20 minutes (plus soaking and fermenting) |
| Cook | 40 minutes |
| Total | About 15 hours (mostly hands-off) |
| Difficulty | Medium |
...
**For the batter**
- 300 g raw rice (any short- or medium-grain variety), soaked in cold water for 6 hours and drained
- 100 g cooked plain rice (leftover rice is ideal)
- 100 ml fresh coconut milk (or canned full-fat coconut milk)
- 5 g active dry yeast (about 1½ teaspoons)
- 10 g sugar (about 2 teaspoons)
- 5 g fine salt (about 1 teaspoon)
...
1. **Grind the batter.** Drain the soaked raw rice (300 g). In a blender or wet grinder, combine the soaked raw rice, cooked rice (100 g), and about 150 ml of water. Blend for 4–5 minutes until the batter is very smooth. Rub a little between your fingers; it should feel silky with only the faintest grain. Add more water in small amounts if the batter is too thick to blend smoothly. The final consistency should be like slightly thick cream.

2. **Add coconut milk (100 ml), yeast and seasonings.** Transfer the ground batter to a large bowl. It will expand significantly during fermentation. Stir in the coconut milk. In a small cup, dissolve the yeast and sugar (2 teaspoons) in 2 tablespoons of warm (not hot) water and leave for 5 minutes until foamy. Add the yeast mixture to the batter along with the salt (1 teaspoon). Stir well to combine.
...
6. **Cover and cook.** Place the lid on the pan immediately. Cook on low heat for 2–3 minutes. The appam is ready when the edges are golden-brown, crisp, and slightly pulled away from the sides of the pan, and the center is set but still soft and white, not dried out. Do not flip an appam. It cooks on one side only.

7. **Remove carefully.** Slide a thin spatula around the edges, then lift the appam out. Serve immediately. Appam does not hold well once removed from the pan. Cook the remaining batter in the same way, wiping and regreasing the pan lightly between each appam.
