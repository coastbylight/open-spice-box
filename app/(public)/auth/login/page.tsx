    ...
    <div className="min-h-[80vh] bg-parchment-50 flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl border border-parchment-200 p-8 shadow-sm">
          {/* Success message */}
          {successMessage && (
            <div className="mb-6 rounded-lg bg-sage-50 border border-sage-200 px-4 py-3 text-sage-700 text-sm font-body">
              {successMessage}
            </div>
          )}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white px-3 text-charcoal-400 font-body">or sign in with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="password" className="block text-sm font-body font-medium text-charcoal-700">
                  Password
                </label>
                <Link
                  href={`/auth/reset-password${redirectTo !== '/' ? `?redirectTo=${encodeURIComponent(redirectTo)}` : ''}`}
                  className="text-xs font-body text-ochre-600 hover:text-ochre-700 transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ochre-400 focus-visible:ring-offset-2 rounded"
                >
                  Forgot password?
                </Link>
              </div>
