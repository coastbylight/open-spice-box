...
| Clay Beige | `#E6D3B3` |
| Warm Taupe | `#B7A99A` |
| Charcoal Brown | `#4A3F35` |
| Turmeric Accent | `#E1A80A` |

- These are the only approved brand colors. Do not use default Tailwind palette colors (no indigo-500, blue-600, etc.).
- Derive all UI color decisions from this palette.
- Charcoal Brown (`#4A3F35`) is the primary text and dark surface color.
- Clay Beige (`#E6D3B3`) is the primary background / base surface.
- Turmeric Accent (`#E1A80A`) is the highlight / CTA color — use sparingly.
